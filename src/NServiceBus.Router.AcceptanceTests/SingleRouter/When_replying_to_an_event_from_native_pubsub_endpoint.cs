...
namespace NServiceBus.Router.AcceptanceTests.SingleRouter
{
    ...
    [TestFixture]
    public class When_replying_to_an_event_from_native_pubsub_endpoint : NServiceBusAcceptanceTest
    {
        ...
        public async Task It_should_deliver_the_message_to_both_subscribers()
        {
            var result = await Scenario.Define<Context>()
                .WithRouter("Router", cfg =>
                {
                    ...
                    cfg.AddInterface<TestTransport>("Right", t => t.BrokerZulu());
        ...
        class Subscriber : EndpointConfigurationBuilder
        {
            public Subscriber()
            {
                EndpointSetup<DefaultServer>(c =>
                {
                    ...
                    var routing = c.UseTransport<TestTransport>().BrokerZulu().Routing();
